...
public class ClientController {
    ...
    @Autowired
    private MicroserviceProductProxy ProduitsProxy;
    ...
    public String passerCommande(@PathVariable int idProduit, @PathVariable Double montant,  Model model){
        ...
        CommandesBean commande = new CommandesBean();
        ...
        CommandesBean commandeAjoutee = CommandesProxy.ajouterCommande(commande);
